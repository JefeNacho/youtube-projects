 ...
 * Size: 14 px
 * Bpp: 1
 * Opts: --bpp 1 --size 14 --font C:/Users/Ignacio/Documents/YouTube_Studio/EuroTruck_Sim_Project/Squareline/assets/Inter.ttf -o C:/Users/Ignacio/Documents/YouTube_Studio/EuroTruck_Sim_Project/Squareline/assets\ui_font_FontUISmall.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/

#include "ui.h"

#ifndef UI_FONT_FONTUISMALL
#define UI_FONT_FONTUISMALL 1
#endif

#if UI_FONT_FONTUISMALL
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_FontUISmall = {
#else
lv_font_t ui_font_FontUISmall = {
#endif
