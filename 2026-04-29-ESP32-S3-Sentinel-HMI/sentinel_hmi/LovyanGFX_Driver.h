...
public:
  ...
  LGFX(void) {
...

    {
      ...
      cfg.use_psram = 1; // Usar PSRAM para el Bounce Buffer (vital para ST7265)
...

    {
      ...
      // Pines copiados exactamente del proyecto base Elecrow 4.3
      ...
      cfg.freq_write = 21000000; // Frecuencia óptima de actualización
...

    {
      ...
      // I2C GT911 Configuration
      cfg.i2c_port = I2C_NUM_0;
      cfg.pin_sda = GPIO_NUM_15;
      cfg.pin_scl = GPIO_NUM_16;
      cfg.pin_rst = -1;
      cfg.freq = 400000;
      cfg.i2c_addr = 0x5D; // GT911 default addr en la placa
